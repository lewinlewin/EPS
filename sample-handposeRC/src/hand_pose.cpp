...
:deviceId_(0), context_(nullptr), stream_(nullptr), modelWidth_(modelWidth),
 modelHeight_(modelHeight), isInited_(false), send_mode(send_mode){
    ...
    if(send_mode == SEND_TO_I2C){
        ...
        if(uart_ctrl.uart_set_option(9600,8,'N',1) < 0)
        {
...
Result HandPose::Postprocess(cv::Mat& origImage, aclmdlDataset* modelOutput) {
    ...
    switch(rc_command){
        case 0: one_result.result_text.append("NOTHING ON"); break;
        case 1: one_result.result_text.append("LIGHT 1 ON"); break;
        case 2: one_result.result_text.append("LIGHT 1 OFF"); break;
        case 3: one_result.result_text.append("LIGHT 2 ON"); break;
        case 4: one_result.result_text.append("LIGHT 2 OFF"); break;
    }
